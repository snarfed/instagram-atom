...
def store_feed():
  ...
  as1, actor = instagram.Instagram().scraped_to_activities(html, fetch_extras=False)
  Feed.get_or_insert(token, html=html, as1_json=json_dumps(as1),
                     actor_json=json_dumps(actor))
  return 'OK'
